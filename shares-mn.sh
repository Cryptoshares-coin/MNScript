#!/bin/bash
# CRYPTOSHARES Masternode Setup Script V1.0.0 for Ubuntu LTS
#
...
echo -e "${GREEN} ------- CRYPTOSHARES MASTERNODE INSTALLER V1.0.0--------+
 |                                                  |
 |                                                  |::
...
wget https://github.com/Cryptoshares-coin/shares/releases/download/1.0.0/shares-1.0.0-linux.tar.gz
...
cd ~/.cryptoshares && wget https://github.com/Cryptoshares-coin/shares/releases/download/1.0.0/bootstrap.zip
